    ...
    if is_ai_toolkit:
        ...
        config_mapping = {
            228: {
                "network_dim": 64,
                "network_alpha": 32,
                "network_args": ["conv_dim=8", "conv_alpha=4", "dropout=0.01"]
            },
            235: {
                "network_dim": 128,
                "network_alpha": 64,
                "network_args": ["conv_dim=16", "conv_alpha=8", "dropout=0.01"]
            },
            456: {
                "network_dim": 128,
                "network_alpha": 64,
            ...
            699: {
                "network_dim": 192,
                "network_alpha": 96,
                "network_args": ["conv_dim=32", "conv_alpha=16", "dropout=0.01"]
            },
        }
